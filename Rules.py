class Rules:
        ...
        for row in range(8):
            for col in range(8):
                ...
                if my_color in piece:
                    my_color_valid_moves.extend(
                        self.get_list_of_valid_moves(board, my_color, [3 * col + 2, 3 * row + 2]))
    ...
    def pawn_change(self, my_color, start_pos, end_pos):
        start_pos_r = start_pos[1]
        start_pos_c = start_pos[0]
        end_pos_r = end_pos[1]
        start_piece = self.board[start_pos_r][start_pos_c]
        ...
        if 'P' in start_piece and (end_pos_r == 2 or end_pos_r == 23):
            piece = input('Please choose a piece:\n Q.queen     R.rock\nB.bishop     N.knight\n')
            self.board[start_pos_r][start_pos_c] = pieces[piece]
